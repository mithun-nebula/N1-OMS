...
const spec = {
  ...
  paths: {
    ...
    "/api/brief": { get: { summary: "Daily briefing", tags: ["assistant"] } },
    "/api/day": { get: { summary: "Start day / dashboard", tags: ["assistant"] }, post: { summary: "Plan actions", tags: ["assistant"] } },
    "/api/news": { get: { summary: "Technology & AI news (same for everyone)", tags: ["assistant"] } },
