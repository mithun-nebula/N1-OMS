...
export function seedWorkplace(ctx: DomainContext): void {
  ...
  ctx.graph.putNode("equipment", "projector-hall-1", {
    name: "Hall 1 Projector",
    assignee: "hall-1",
    status: "ok",
  });

  ctx.graph.putNode("calendar-entry", "cal-showcase", {
    title: "SHOWCASE",
    kind: "event",
    date: "2026-08-18",
    people: ["james", "priya", "arun"],
  });
  ctx.graph.putNode("calendar-entry", "cal-town-hall", {
    title: "TOWN HALL",
    kind: "event",
    date: "2026-08-28",
    people: [],
